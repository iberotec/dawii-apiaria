CREATE DATABASE  IF NOT EXISTS `db_sistema_apiario` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `planilla_revision` (
  ...
  CONSTRAINT `fk_planilla_revision_usuario2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_planilla_revision_temporada1` FOREIGN KEY (`temporada_id_temporada`) REFERENCES `temporada` (`id_temporada`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-11-25  3:36:20
