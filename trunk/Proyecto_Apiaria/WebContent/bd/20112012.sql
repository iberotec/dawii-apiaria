...
CREATE SCHEMA IF NOT EXISTS `db_sistema_apiario` DEFAULT CHARACTER SET latin1 ;
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`apiario` (
  ...
  `descripcion_apiario` VARCHAR(45) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`centrifugadora` (
  ...
  `nombre_centrifugadora` VARCHAR(45) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`detalle_apiario_norma_seg` (
  `estado_conformidad` VARCHAR(50) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`usuario` (
  ...
  `nom_usu` VARCHAR(45) NULL DEFAULT NULL ,
  `ape_usu` VARCHAR(45) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`reina` (
  ...
  `descripcion` VARCHAR(45) NULL DEFAULT NULL ,
  `idcolmena` INT(11) NOT NULL ,
  `genetica` VARCHAR(45) NULL DEFAULT NULL ,
  PRIMARY KEY (`idreina`) ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`planilla_revision` (
  `estado_colmena` VARCHAR(45) NULL DEFAULT NULL ,
  `necesidad_alimentacion` TINYINT(1) NULL DEFAULT NULL ,
  `necesidad_curacion` TINYINT(1) NULL DEFAULT NULL ,
  `falta_espacio_camara_cria` TINYINT(1) NULL DEFAULT NULL ,
  `peligro_colmena` VARCHAR(45) NULL DEFAULT NULL ,
  `idestado_revision` INT(11) NOT NULL ,
  `comportamiento` VARCHAR(150) NULL DEFAULT NULL ,
  `idreina` INT(11) NOT NULL ,
  `falta_alza` TINYINT(1) NULL DEFAULT NULL ,
  `existencia_reina` TINYINT(1) NULL DEFAULT NULL ,
  `idusuario` INT(11) NOT NULL ,
  `idcolmena` INT(11) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`detalle_planilla_revision_alza` (
  `estado_deterioro_alza` VARCHAR(45) NULL DEFAULT NULL ,
  `porcentaje_miel` DECIMAL(10,0) NULL DEFAULT NULL ,
  `porcentaje_polen` DECIMAL(10,0) NULL DEFAULT NULL ,
  `estado_alza` VARCHAR(45) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`detalle_planilla_revision_tipo_enfermedad` (
  `mienbro_enfermo` VARCHAR(45) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`pais` (
  ...
  `nom_pais` VARCHAR(45) NULL DEFAULT NULL ,
  PRIMARY KEY (`idpais`) )
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = latin1;
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`detalle_rec_nat_zona` (
  `porcentaje_recurso` DECIMAL(10,0) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`detalle_tipo_enfe_tratamiento` (
  `dosis` VARCHAR(150) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`detalle_usuario_enva` (
  `fecha_uso` VARCHAR(10) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`planilla_envasado` (
  `fecha_envasado` VARCHAR(45) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `db_sistema_apiario`.`planilla_seguimiento` (
  `motivo_ubicacion` VARCHAR(45) NULL DEFAULT NULL ,
